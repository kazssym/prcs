 ...
 *
 * $Id: quick.cc 1.7.1.2.2.8.1.6 Sat, 27 Jan 2007 15:46:30 -0800 jmacd $
 */
...
PrVoidError QuickElim::update_file(const char* filename) const
{
	...
	prcswarning << "Unlink failed on auxiliary file " << squote(filename) << perror;
